            ...
            <div className="row">
                <div className="col-9">
                    ...
                    <div className="your-terms">
                        <div className="col-4">
                            <img className="polygon1" src="/images/polygon1.png" alt="" />
                            <img className="polygon2" src="/images/polygon2.png" alt="" />
                            <p><strong>Profit Share</strong></p>
                            <p>Shared risk and returns, with our 'Profit-First' approach</p>
                        </div>
                        <div className="col-4">
                            <img className="hex1" src="/images/hex1.png" alt="" />
                            <img className="hex2" src="/images/hex2.png" alt="" />
                            
                            <p><strong>Fast and Unbiased</strong></p>
                            <p>Our machine learning assistant, AskRia ensures a quick, human-biased free process</p>
                        </div>
                        <div className="col-4">
                            <img className="triangle1" src="/images/triangle1.png" alt="" />
                            <img className="triangle2" src="/images/triangle2.png" alt="" />
                            <br />
                ...
                <div className="col-3">
                    <img id="terms-img" src="/images/terms.png" alt="" />
                </div>
            </div>
        </div>
    </section>
