        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-4">
                    ...
                    <img className="content-icons" src="/images/insider.png" alt="" />
